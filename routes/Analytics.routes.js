...
import { getDoctorPatients } from "../controllers/doctorPatients.controller.js";
...
// GET /api/admin/analytics/doctor/:doctorId/patients?filter=today
// GET /api/admin/analytics/doctor/:doctorId/patients?filter=7days
// GET /api/admin/analytics/doctor/:doctorId/patients?filter=custom&customStart=2025-04-01&customEnd=2025-04-23
router.get("/doctor/:doctorId/patients", isAdmin, getDoctorPatients);
